    ...
    return(
        //  <section className='sm:flex block w-full'>
         <div className='sm:w-1/2 w-full sm:mt-10 '>
                 ...
                 fixed sm:-top-15 -top-10 backdrop-blur-md border-2 border-white bg-white/30 rounded-full shadow-md z-50 mt-20 w-full  sm:w-1/2  h-20'>
                        <div className='flex '>
                        <img className='sm:mr-20 mr-0 h-10 items-center sm:mt-3 mt-4' src={Logo} alt="" />
                        {!isMenuOpen ? 
                        <img id='menu-btn' onClick={() => toggleMenu()} className='w-5 h-8 sm:hidden ml-35  mt-5 ' src={Menu} alt="" />
                        :
                          <span onClick={() => toggleMenu()} className='w-5  sm:hidden ml-35 mt-5 text-4xl  text-blue-600'>X</span>
                      }
