    ...
    return(
        //  <section className='sm:flex block w-full'>
         <div className='sm:w-1/2 w-full sm:mt-10 '>
                 ...
                 fixed sm:-top-15 -top-10 backdrop-blur-md bg-white/30 rounded-full shadow-md z-50 mt-20 w-full sm:w-1/2  h-20'>
                        <div className='flex '>
                        ...
                        <div id='main-menu' className={
                            'flex flex-col md:flex-row mt-10 gap-6 backdrop-blur-md bg-white/80 md:bg-transparent rounded-lg items-center  ' + `${isMenuOpen? ' flex' : 'md:flex hidden'}` 
                        }>
