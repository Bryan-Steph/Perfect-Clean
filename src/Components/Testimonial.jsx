    ...
    return(<>
        <section className="mt-10">
            <div className="sm:flex">
                <h1 className=" sm:w-1/2 font-bold text-4xl mx-5 sm:mx-0'"><span
                 className="text-blue-500 font-extrabold text-6xl font-sans">250 +</span>Satisfied Clients 
                With Our Services</h1>
                <div className="sm:w-1/2">
                <p className="text-orange-500 font-semibold text-3xl mx-5 my-10 sm:my-0">Testimonials</p>
                <p className="sm:mt-5 mx-5">Have many related needs, we present a suitable package for your needs</p>
                </div>
            </div>
