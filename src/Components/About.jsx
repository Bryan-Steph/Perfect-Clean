    ...
    return(<>
            <div>
                <div className=' sm:h-140 bg-[#dcfbd233] h-130 bg-[url(./assets/images/Vector.png)] bg-no-repeat bg-cover '>
                    <h1 className='mx-10 md:ml-20 text-5xl font-bold pt-10 md:w-150 mt-5 '>Are You Ready To Work With Us Now?</h1>
                    ...
                    <div className='mt-7 mx-10 h-10  w-50 flex rounded-lg border-4 border-blue-500
                     hover:transition-all hover:bg-blue-700 hover:scale-110'>
                        <img className='h-8 ' src={Play} alt="" />
